...
const translations = {
  en: {
    ...
    'loan.loanOverview': 'Loan overview',
    'loan.startDate': 'Start date',
    'loan.endDate': 'Maturity',
    ...
    'loan.paymentHistorySubtitle': 'Track every installment and adjustment.',
    ...
    'loan.statusActiveDescription':
      'You are on track - keep the regular payments going.',
    'loan.statusPendingDescription':
      'Schedule your first payment to kick things off.',
    'loan.statusCompletedDescription': 'Great job! This loan is fully repaid.',
    'loan.toolbarOverview': 'Home',
    'loan.toolbarProgress': 'Progress',
    'loan.toolbarAmount': 'Amount',
    'loan.toolbarDocs': 'Docs',
    'loan.averageInstallment': 'Avg. installment',
    'loan.lastPayment': 'Last payment',
  ...
  ro: {
    ...
    'loan.loanOverview': 'Prezentare împrumut',
    'loan.startDate': 'Data începerii',
    'loan.endDate': 'Scadență',
    'loan.rate': 'Dobândă',
    'loan.principal': 'Principal',
    'loan.paid': 'Plătit',
    ...
    'loan.paymentHistorySubtitle': 'Monitorizează fiecare rată și ajustare.',
    ...
    'loan.statusActiveDescription':
      'Ești pe drumul cel bun - continuă plățile la timp.',
    'loan.statusPendingDescription':
      'Programează prima plată pentru a porni.',
    'loan.statusCompletedDescription': 'Felicitări! Împrumutul este achitat.',
    'loan.toolbarOverview': 'Acasă',
    'loan.toolbarProgress': 'Progres',
    'loan.toolbarAmount': 'Sume',
    'loan.toolbarDocs': 'Documente',
    'loan.averageInstallment': 'Rată medie',
    'loan.lastPayment': 'Ultima plată',
