...
const translations = {
  en: {
    ...
    'profile.quickAddSuggestion': 'Quick Add Suggestion',
    'profile.quickAddSuggestionDesc':
      'Show a suggestion to add a transaction when entering the app (with pre-filled amount, category and description)',
    'profile.quickAddSuggestionEnabled': 'Show suggestion on app open',
    'profile.quickAddAmount': 'Default amount',
    'profile.quickAddCategory': 'Default category',
    'profile.quickAddDescription': 'Default description',
    'profile.quickAddDaysOfWeek': 'Days of week',
    'profile.quickAddDaysHint': 'If none selected, suggestion shows every day',
    'profile.quickAddDaySun': 'Sun',
    'profile.quickAddDayMon': 'Mon',
    'profile.quickAddDayTue': 'Tue',
    'profile.quickAddDayWed': 'Wed',
    'profile.quickAddDayThu': 'Thu',
    'profile.quickAddDayFri': 'Fri',
    'profile.quickAddDaySat': 'Sat',
    'profile.quickAddTimeSlots': 'Time slots',
    'profile.quickAddTimeSlotsHint': 'If empty, suggestion shows at any time',
    'profile.quickAddTimeSlotStart': 'From',
    'profile.quickAddTimeSlotEnd': 'To',
    'profile.quickAddAddSlot': 'Add time slot',
    'profile.quickAddRemoveSlot': 'Remove',
  ...
  ro: {
    ...
    'profile.quickAddSuggestion': 'Sugestie adăugare rapidă',
    'profile.quickAddSuggestionDesc':
      'Afișează o sugestie de adăugare tranzacție la intrarea în aplicație (cu sumă, categorie și descriere precompletate)',
    'profile.quickAddSuggestionEnabled': 'Arată sugestia la deschiderea aplicației',
    'profile.quickAddAmount': 'Suma implicită',
    'profile.quickAddCategory': 'Categoria implicită',
    'profile.quickAddDescription': 'Descrierea implicită',
    'profile.quickAddDaysOfWeek': 'Zile din săptămână',
    'profile.quickAddDaysHint': 'Dacă nu e selectată niciuna, sugestia apare în fiecare zi',
    'profile.quickAddDaySun': 'Dum',
    'profile.quickAddDayMon': 'Lun',
    'profile.quickAddDayTue': 'Mar',
    'profile.quickAddDayWed': 'Mie',
    'profile.quickAddDayThu': 'Joi',
    'profile.quickAddDayFri': 'Vin',
    'profile.quickAddDaySat': 'Sâm',
    'profile.quickAddTimeSlots': 'Intervale orare',
    'profile.quickAddTimeSlotsHint': 'Dacă e gol, sugestia apare la orice oră',
    'profile.quickAddTimeSlotStart': 'De la',
    'profile.quickAddTimeSlotEnd': 'Până la',
    'profile.quickAddAddSlot': 'Adaugă interval',
    'profile.quickAddRemoveSlot': 'Elimină',
