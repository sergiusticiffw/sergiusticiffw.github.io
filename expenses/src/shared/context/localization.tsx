...
const translations = {
  en: {
    ...
    'suggestions.clothing.nelea': 'Nelea',
    'suggestions.clothing.leo': 'Leo',
    'suggestions.clothing.sergiu': 'Sergiu',
    ...
    'suggestions.entertainment.alcool': 'alcohol',
    ...
    'suggestions.gifts.nelea': 'Nelea',
    'suggestions.gifts.sergiu': 'Sergiu',
    'suggestions.household.igiena': 'hygiene/cleaning',
    'suggestions.household.scutece': 'diapers',
    'suggestions.household.leo': 'Leo',
    ...
    'suggestions.health.nelea': 'Nelea',
    'suggestions.health.sergiu': 'Sergiu',
    'suggestions.health.leo': 'Leo',
    ...
    'suggestions.personal.nelea': 'Nelea',
    'suggestions.personal.sergiu': 'Sergiu',
    'suggestions.personal.beauty': 'beauty',
    ...
    'suggestions.utilities.orange': 'orange',
    ...
    'suggestions.family.nelea': 'Nelea',
    'suggestions.family.leo': 'Leo',
    'suggestions.family.sergiu': 'Sergiu',
    ...
    'loan.nextPayment': 'Next Payment',
    'loan.nextPaymentRegular': 'Regular',
    ...
    'loan.dailyInterest': 'Daily Interest (current)',
    'loan.interestSavings': 'Interest Saved',
    'loan.principalPaid': 'Principal Paid',
    'loan.remainingPrincipal': 'Remaining Principal',
    'loan.kpi.principal': 'Principal Amount',
    'loan.kpi.totalInterest': 'Total Interest Paid',
    'loan.kpi.totalCost': 'Total Cost of Loan',
    'loan.kpi.payoffDate': 'Estimated Payoff',
    'loan.kpi.interestRatio': 'Interest/Principal',
    'loan.detailsPanel': 'Loan Details',
    'loan.health.title': 'Loan Health Score',
    'loan.health.excellent': 'Excellent',
    'loan.health.moderate': 'Moderate',
    'loan.health.needsAttention': 'Needs Attention',
    'loan.health.explanation.excellent':
      'You are making strong progress with a healthy repayment pace and manageable interest burden.',
    'loan.health.explanation.moderate':
      'Your loan is on track, but extra payments could reduce interest costs and shorten the term.',
    'loan.health.explanation.needsAttention':
      'Consider increasing payments or reviewing your repayment strategy to reduce long-term interest costs.',
    'loan.insights.title': 'Smart Insights',
    'loan.insight.interestPace':
      'At your current pace, you will pay {interest} in interest. By paying an extra {extra} per month, you could finish {months} months earlier and save {savings} in interest.',
    'loan.insight.payoffTrack':
      'You are on track to repay this loan by {date}.',
    'loan.insight.progress':
      'You have repaid {percent}% of your loan — keep up the momentum!',
    'loan.insight.extraSavings':
      'Paying an extra {extra}/month could save you {savings} in interest and shorten your loan by {months} months.',
    ...
    'loan.simulator.monthsSaved': 'Months Saved',
    'loan.simulator.interestSaved': 'Interest Saved',
    'loan.simulator.showSchedule': 'Preview updated schedule',
    'loan.simulator.hideSchedule': 'Hide schedule preview',
    'loan.milestones.title': 'Repayment Milestones',
    'loan.milestones.paid25': '25% Paid',
    'loan.milestones.paid50': '50% Paid',
    'loan.milestones.paid75': '75% Paid',
    'loan.milestones.fullyPaid': 'Fully Paid',
    'loan.milestones.estimated': 'Estimated',
    'loan.upcoming.title': 'Upcoming Payments',
    'loan.upcoming.daysLeft': '{days} days left',
    'loan.upcoming.overdue': 'Overdue',
    'loan.upcoming.scheduled': 'Scheduled payments',
    'loan.recommendations.title': 'Personalized Recommendations',
    'loan.rec.add50': 'Adding $50/month could save you {savings} in interest.',
    'loan.rec.onTrack': 'You are on track to repay this loan by {date}.',
    'loan.rec.principalPortion':
      '{percent}% of your remaining payments go toward principal.',
    'loan.rec.extra100':
      'Paying an extra $100/month saves {savings} in interest and {months} months.',
    'loan.rec.almostDone': 'Only {percent}% left — you are almost done!',
    'loan.charts.principalVsInterest': 'Principal vs Interest',
    'loan.charts.scenarioComparison': 'Scenario Comparison',
    'loan.charts.currentPlan': 'Current Plan',
    'loan.charts.custom': 'Custom',
    'loan.charts.months': 'Months',
    'loan.charts.monthsToPayoff': 'Months to Payoff',
    'loan.visualizations': 'Visualizations',
    'loan.dashboard': 'Loan Planning',
    ...
    'loanForm.paymentMethod': 'Payment Method',
    'loanForm.methodEqualInstallment': 'Equal Installment (Annuity)',
    'loanForm.methodEqualPrincipal': 'Equal Principal (Decreasing)',
    ...
    'paymentForm.newPrincipalBalance': 'New Principal Balance',
    'paymentForm.newPaymentMethod': 'New Payment Method',
    'paymentForm.keepCurrentMethod': 'Keep Current Method',
  ...
  ro: {
    ...
    'suggestions.entertainment.alcool': 'alcool',
    'suggestions.food.market': 'market',
    ...
    'loan.nextPayment': 'Următoarea Plată',
    'loan.nextPaymentRegular': 'Regular',
    ...
    'loan.dailyInterest': 'Dobândă zilnică (curent)',
    'loan.interestSavings': 'Dobândă Economisită',
    'loan.principalPaid': 'Principal Achitat',
    'loan.remainingPrincipal': 'Principal Rămas',
    'loan.kpi.principal': 'Suma Principală',
    'loan.kpi.totalInterest': 'Dobândă Totală Achitată',
    'loan.kpi.totalCost': 'Cost Total al Împrumutului',
    'loan.kpi.payoffDate': 'Estimare Finalizare',
    'loan.kpi.interestRatio': 'Dobândă/Principal',
    'loan.detailsPanel': 'Detalii Împrumut',
    'loan.health.title': 'Scor Sănătate Împrumut',
    'loan.health.excellent': 'Excelent',
    'loan.health.moderate': 'Moderat',
    'loan.health.needsAttention': 'Necesită Atenție',
    'loan.health.explanation.excellent':
      'Progresezi bine, cu un ritm sănătos de rambursare și o povară a dobânzii gestionabilă.',
    'loan.health.explanation.moderate':
      'Împrumutul este pe drumul cel bun, dar plăți suplimentare ar putea reduce costurile cu dobânda.',
    'loan.health.explanation.needsAttention':
      'Consideră creșterea plăților sau revizuirea strategiei de rambursare pentru a reduce costurile pe termen lung.',
    'loan.insights.title': 'Perspective Inteligente',
    'loan.insight.interestPace':
      'La ritmul actual, vei plăti {interest} dobândă. Plătind extra {extra} pe lună, ai putea termina cu {months} luni mai devreme și economisi {savings} dobândă.',
    'loan.insight.payoffTrack':
      'Ești pe drumul să rambursezi acest împrumut până la {date}.',
    'loan.insight.progress':
      'Ai rambursat {percent}% din împrumut — continuă tot așa!',
    'loan.insight.extraSavings':
      'Plata a {extra} extra pe lună ar putea economisi {savings} dobândă și scurta împrumutul cu {months} luni.',
    ...
    'loan.simulator.monthsSaved': 'Luni Economisite',
    'loan.simulator.interestSaved': 'Dobândă Economisită',
    'loan.simulator.showSchedule': 'Previzualizare program actualizat',
    'loan.simulator.hideSchedule': 'Ascunde previzualizarea',
    'loan.milestones.title': 'Repere de Rambursare',
    'loan.milestones.paid25': '25% Achitat',
    'loan.milestones.paid50': '50% Achitat',
    'loan.milestones.paid75': '75% Achitat',
    'loan.milestones.fullyPaid': 'Complet Achitat',
    'loan.milestones.estimated': 'Estimat',
    'loan.upcoming.title': 'Plăți Viitoare',
    'loan.upcoming.daysLeft': '{days} zile rămase',
    'loan.upcoming.overdue': 'Întârziat',
    'loan.upcoming.scheduled': 'Plăți programate',
    'loan.recommendations.title': 'Recomandări Personalizate',
    'loan.rec.add50': 'Adăugarea a $50/lună ar putea economisi {savings} dobândă.',
    'loan.rec.onTrack': 'Ești pe drumul să rambursezi acest împrumut până la {date}.',
    'loan.rec.principalPortion':
      '{percent}% din plățile rămase merg spre principal.',
    'loan.rec.extra100':
      'Plata a $100 extra pe lună economisește {savings} dobândă și {months} luni.',
    'loan.rec.almostDone': 'Doar {percent}% rămas — ești aproape gata!',
    'loan.charts.principalVsInterest': 'Principal vs Dobândă',
    'loan.charts.scenarioComparison': 'Comparație Scenarii',
    'loan.charts.currentPlan': 'Plan Actual',
    'loan.charts.custom': 'Personalizat',
    'loan.charts.months': 'Luni',
    'loan.charts.monthsToPayoff': 'Luni până la Finalizare',
    'loan.visualizations': 'Vizualizări',
    'loan.dashboard': 'Planificare Împrumut',
    ...
    'loanForm.paymentMethod': 'Metoda de Rambursare',
    'loanForm.methodEqualInstallment': 'Rate Egale (Anuitate)',
    'loanForm.methodEqualPrincipal': 'Principal Egal (Rate Descrescătoare)',
    ...
    'paymentForm.newPrincipalBalance': 'Sold Principal Nou',
    'paymentForm.newPaymentMethod': 'Metodă Nouă de Rambursare',
    'paymentForm.keepCurrentMethod': 'Păstrează Metoda Curentă',
