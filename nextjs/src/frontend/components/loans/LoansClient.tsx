                ...
                return (
                  <tr key={loan.id} className="border-t border-white/10">
                    ...
                    <td className="py-3 pr-3 flex gap-2">
                      ...
                      <button
                        className="rounded border border-red-400/30 bg-red-500/10 px-3 py-1.5 text-red-300"
                        onClick={async () => {
                          if (!loan.id) return
